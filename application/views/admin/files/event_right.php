                ...
                <div class="modal-content animated pulse">
                    ...
                    <div class="modal-body padding-bottom padding-top">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="<?php echo base_url(); ?>admin/events/delete/<?php echo $gs->NO; ?>" type="button" id="btn_delete_team" class="btn btn-danger btn-lg full-width">Delete</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content animated pulse">
                    ...
                    <div class="modal-body no-padding-bottom">
                        <form method="POST" enctype="multipart/form-data" action="<?php echo base_url();?>admin/events/update">
