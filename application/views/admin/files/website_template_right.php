<div class="ibox no-margin">
    ...
    <div class="ibox-content min-height no-padding-bottom">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content animated pulse">
                    ...
                    <div class="modal-body padding-bottom padding-top">
                        <form method="POST" enctype="multipart/form-data" action="<?php echo base_url();?>admin/website_template/update_image/<?php echo $gao->NO;?>">
                            <div class="form-group">
