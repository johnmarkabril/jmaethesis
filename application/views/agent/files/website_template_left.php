                            ...
                            <?php if(!empty($get_all_templates)) {?>
                                <tbody class="list">
                                    <?php foreach($get_all_templates as $gat) :?>
                                        <tr>
                                            <td class="title">
                                                <a href="<?php echo base_url();?>agent/templates/information/<?php echo $gat->NO;?>"><?php echo $gat->TEMPLATENAME;?></a>
                ...
                <div class="modal-content animated pulse">
                    ...
                    <div class="modal-body padding-bottom padding-top">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="<?php echo base_url(); ?>agent/templates/delete/<?php echo $gat->NO; ?>" name="btn_delete_wt" class="btn btn-danger btn-lg full-width">Delete</a>
                            </div>
                        </div>
                    </div>
                </div>
