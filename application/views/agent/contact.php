    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content animated pulse">
            ...
            <div class="modal-body no-padding-bottom">
                <form role="form" id="formContactDash" enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>agent/contact/insert">
...
<?php $this->load->view('agent/files/contact_content'); ?>